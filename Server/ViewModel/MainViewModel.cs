...
namespace Server.ViewModel
{
    public class MainViewModel:BaseViewModel
    {
        ...
        public List<PDFs> PDFs { get; set; }

        string text = String.Empty;
        private PDFs selecteditempdf;

        public PDFs SelectedItemPdf
        {
        ...
        public MainViewModel(MainWindow mainWindow)
        {
            ...
            ConnectBtnCLick = new RelayCommand((sender) =>
            {
                ...
                Task.Run(() =>
                {
                    ...
                    var ep = new IPEndPoint(ip, Connect.Port);
                                ...
                                while (true)
                                {
                                    ...
                                    if (".pdf".Equals(Path.GetExtension(path: Path1), StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        App.Current.Dispatcher.Invoke(() =>
                                        {
                                            ...
                                            mainWindow.Listbox.Items.Add(new PDFs { ImagePath = "/Images/pdficon.png", PdfPath = Path1, SenderName = $"Sender Name : {t}" });
